...
class DataBaseModel : public QObject
{
    ...
    Q_PROPERTY(int weeklyMetersRun READ weeklyMetersRun WRITE setweeklyMetersRun NOTIFY weeklyMetersRunChanged)
    ...
    Q_PROPERTY(int weeklyGoal READ weeklyGoal WRITE setWeeklyGoal NOTIFY weeklyGoalChanged)
