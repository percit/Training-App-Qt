...
macro(add_qt_android_apk TARGET SOURCE_TARGET)
    ...
    if(${Qt6Core_VERSION} VERSION_GREATER_EQUAL 6.14)
    ...
    if(QT_ANDROID_SUPPORT_MULTI_ABI)
        # from Qt 6.14 qtandroideploy will find the correct stl.
    ...
    # From Qt 6.14 qtandroideploy "target-architecture" is no longer valid in input file
    # It have been replaced by "architectures": { "${ANDROID_ABI}": "${ANDROID_ABI}" }
    # This allow to package multiple ABI in a single apk
    # For now we only support single ABI build with this script (to ensure it work with Qt6.14 & Qt6.16)
    if(QT_ANDROID_SUPPORT_MULTI_ABI)
